...
Follow the setup instructions on the [Pi repository](https://github.com/badlogic/pi-mono/tree/main/packages/coding-agent). Run pi by typing `pi` into your terminal. This will create the `PI_DIR` directory.
